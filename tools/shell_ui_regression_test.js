...
requireText(worker, "const CACHE = 'veda-shell-1.74'", 'Shell cache version is stale');
requireText(worker, '/static/spatial-control.js?v=1.74', 'Spatial viewer is missing from the offline shell');
requireText(html, '/static/spatial-control.js?v=1.74', 'Local spatial viewer module is missing');
