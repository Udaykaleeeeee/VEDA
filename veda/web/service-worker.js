const CACHE = 'veda-shell-1.57';
const SHELL = [
  '/', '/manifest.webmanifest', '/static/favicon.svg',
  '/static/app.css?v=1.57', '/static/views.js?v=1.57',
  '/static/vision-tracker.js?v=1.57', '/static/app.js?v=1.57',
  '/static/field-capture.js?v=1.57'
];
