const CACHE = 'veda-shell-1.62';
const SHELL = [
  '/', '/manifest.webmanifest', '/static/favicon.svg',
  '/static/app.css?v=1.62', '/static/views.js?v=1.62',
  '/static/vision-tracker.js?v=1.62', '/static/app.js?v=1.62',
  '/static/field-capture.js?v=1.62',
  '/static/design.css?v=1.62', '/static/assets/pipeline-hero.jpg'
];
